...
def can_be_found_updated_and_saved
  ...
  movie1.update_attributes(:title => "Even Awesomer Flick")
  movie1.save 
  movie1
end
...
def can_update_using_update_method
  ...
  movie1 = Movie.create(title: "Wat?")
  movie1.update_attributes(:title => "Wat, huh?")
  movie1.save 
  movie1
end
...
movie1 = Movie.select(:title).delete_all
# movie1.destroy_all
# #movie1.save
